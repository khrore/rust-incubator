...
- [x] [George He: Thinking in Rust: Ownership, Access, and Memory Safety][19]
- [x] [Chris Morgan: Rust ownership, the hard way][1]
- [x] [Adolfo Ochagavía: You are holding it wrong][12]
- [x] [Vikram Fugro: Beyond Pointers: How Rust outshines C++ with its Borrow Checker][15]
